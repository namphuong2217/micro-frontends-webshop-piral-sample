...
% I have a question related to making the Piral Instance (App Shell) more resilient Is there anything already implemented in Piral core to handle transient failures in connecting to the feed service? Well, Piral itself does not know that you use a feed service or something like that. So you need to make sure that your pilets resolve. The easiest way would be to serve everything from a dynamic web server which combines feed response with the HTML already. It not only is more resilient, but also perf-wise better.
% \url{https://docs.piral.io/guidelines/tutorials/11-server-side-rendering} 
...
\begin{figure}[h!]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[height=6cm]{PI-home.png}
...
\begin{figure}[h!]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[height=6cm]{PI-visualization.png}
...
\begin{figure}[h!]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[height=6cm]{PI-disable-a-pilet.png}
...
\begin{figure}[h!]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[height=6cm]{PI-mfe-extensions.png}
