export const productsRecommendation = [
  ...
  },
  {
    id: "6",
    name: "AYR Red Powder",
    image: require("../assets/images/tea6.jpg"),
    price: 45,
    category: "A",
    description:
  ...
  },
  {
    id: "7",
    name: "Early Spring",
    image: require("../assets/images/tea7.jpg"),
    price: 75,
    category: "C",
    description:
  ...
  },
  {
    id: "8",
    name: "Late Spring",
    image: require("../assets/images/tea8.jpg"),
    price: 95,
    category: "C",
    description:
  ...
  {
    id: "9",
    name: "Green Tea Powder Type B",
    image: require("../assets/images/tea9.jpg"),
    price: 140,
    category: "A",
    description:
      "Key flavors: Herbs, grass, tannins. Pure ground organic green tea leaves grown wild and unshaded in full sun. Nutrient-dense with intense flavor.",
